...
import XCTest
import DekiHelper
@testable import EmailValidationRegex
...
final class EmailValidationTests: XCTestCase {
    ...
    func testEmailWithPlusSign() {
        ...
        for email in emails {
            XCTAssertTrue(email.isValidEmail, "Email validation failed for \(email)")
        }
    }
    ...
    func testEmailWithAllTopLevelDomains() {
        ...
        for email in validEmails {
            for tld in self.topLevelDomains {
                ...
                XCTAssertTrue(modifiedEmail.isValidEmail, "Email validation failed for \(email) - \(modifiedEmail)")
            }
        }
    }
    ...
    func testInvalidEmails() {
        var invalidEmails = [
            ...
            // invalid emails below came from: https://gist.github.com/cjaoude/fd9910626629b53c4d25
            "#@%^%#$@#$@#.com",
            "@example.com",
        ...
        for email in invalidEmails {
            XCTAssertFalse(email.isValidEmail, "Email validation failed for \(email)")
        }
    }
